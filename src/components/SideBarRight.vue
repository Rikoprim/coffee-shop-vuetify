  ...
  <v-navigation-drawer app color="white" right width="290">
    ...
    <v-list subheader two-line class="mt-1">
      <v-list-item>
        ...
        <v-list-item-action class="caption">$7.95</v-list-item-action>
      </v-list-item>
    </v-list>
    ...
    <v-list subheader two-line class="mt-1">
      <v-list-item>
        ...
        <v-list-item-action class="caption">$6.55</v-list-item-action>
      </v-list-item>
    </v-list>
                ...
                <v-row>
                  <v-col cols="12" md="12">
                    <v-list-item three-line class="text-center mt-1">
                      <v-list-item-content>
                        <div>
                          <v-icon :color="active ? '#704323' : 'black'">
